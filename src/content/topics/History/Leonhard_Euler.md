...
The constant's most popular application is in calculus, where the function $e^x$ is its own derivative. This is also the only function in math to have this astonishing property!
$$
\frac{d}{dx}[e^x]=e^x
$$

Among mathematicians, the aptly named Euler's Identity is perhaps the most novel place that `e` appears, for it is widely regarded to be the most beautiful equation in all of mathematics.
$$
e^{i\pi}+1=0
$$
